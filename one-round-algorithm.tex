...
Strong consistency, storage efficiency, and availability are three key features for NoSQL KV-stores. We demonstrated that through  CassandrEAS -- erasure coding can be used to reduce storage cost while incurring moderate performance penalty. One interesting future work is to investigate how to apply \treasmod{} and \oreas{} in other NoSQL KV-stores, or to Cassandra to support transaction-related primitives beyond the simple read or write.\vspace{-3pt}
